    ...
    <div class="relative flex h-full items-center justify-center">
        <div class="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <div class="mt-10 flex items-center justify-center gap-4">
                <a href="#" class="rounded-md bg-red px-6 py-3 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-red-dark">Weekly Bulletin</a>
                <a href="{{ route('ministries.upcoming-events') }}" class="rounded-md border border-white px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-white hover:text-black">Upcoming Events</a>
            </div>
        </div>
    </div>
</section>
