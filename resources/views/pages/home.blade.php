<x-layouts.app>
    ...
    <section class="py-16 sm:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="{{ route('contact') }}" class="mt-8 inline-block rounded bg-teal px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-teal-dark transition-colors">Get Directions & Service Times</a>
        </div>
    </section>
</x-layouts.app>
